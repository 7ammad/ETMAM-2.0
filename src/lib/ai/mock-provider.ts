...
export class MockProvider implements AIProvider {
  ...
  async analyze(
    ...
    return {
      ...
      recommendation_reasoning: "Mock provider — configure GEMINI_API_KEY or GROQ_API_KEY for real analysis.",
      red_flags: [],
      key_dates: [],
    };
  }
  ...
  async extractFromPDF(
    ...
    return {
      ...
      warnings: ["Mock provider — no API key. Set GEMINI_API_KEY or use MOCK_AI for stubs."],
